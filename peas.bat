...
CALL :T_Progress 0
ECHO./^^!\ Advisory: Enum
CALL :ColorLine "   %E%41mMy Local Enum should be used for authorized penetration testing and/or educational purposes only.%E%40;97m"
...
TITLE My Local Enum -  - Scanning... !PercentageTrack!%%
EXIT /B

:ColorLine
SET "CurrentLine=%~1"
FOR /F "delims=" %%A IN ('FORFILES.EXE /P %~dp0 /M %~nx0 /C "CMD.exe /C ECHO.!CurrentLine!"') DO ECHO.%%A
EXIT /B
